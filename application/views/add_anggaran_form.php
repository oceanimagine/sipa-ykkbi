                                ...
                                <table class="styled-table" style="border: #f1f1f1 1px solid; min-width: 1300px;" id="table-anggaran-tahunan<?php echo $alphabet_lanjutan[$keys_ma[$i]]; ?>">
                                    ...
                                    <tbody>
                                        ...
                                        <tr <?php echo $no == $jumlah_rincian ? 'style="border-bottom: rgb(242,220,219) 2px solid;"' : ""; ?> class="anakan_group_<?php echo ($j + 1); ?>">
                                            ...
                                            <td style="text-align: center; border-right: #f0f0f0 1px solid; padding: 0px; vertical-align: middle; width: 6%;"><input <?php echo $disabled_input; ?> autocomplete="off" name="tarif_<?php echo $alphabet_lanjutan[$keys_ma[$i]]; ?>_<?php echo ($j + 1); ?>[]" class="numberonly" type="number" style="background-color: white; box-sizing: border-box; border: none; outline: none;height: 32px; text-align: right;width: 88%;" placeholder="NOM" value="<?php echo $data_rincian_edit_[$k]->rintarif; ?>"></td>
                                            ...
                                            <td style="text-align: center; border-right: #f0f0f0 1px solid; padding: 0px; vertical-align: middle; width: 6%;"><input <?php echo $disabled_input; ?> autocomplete="off" name="tw1_<?php echo $alphabet_lanjutan[$keys_ma[$i]]; ?>_<?php echo ($j + 1); ?>[]" class="numberonly" type="number" style="background-color: white; box-sizing: border-box; border: none; outline: none;height: 32px; text-align: right;width: 88%;" placeholder="NOM" value="<?php echo $data_rincian_edit_[$k]->rppt1nom; ?>"></td>
                                            ...
                                            <td style="text-align: center; border-right: #f0f0f0 1px solid; padding: 0px; vertical-align: middle; width: 6%;"><input <?php echo $disabled_input; ?> autocomplete="off" name="tw2_<?php echo $alphabet_lanjutan[$keys_ma[$i]]; ?>_<?php echo ($j + 1); ?>[]" class="numberonly" type="number" style="background-color: white; box-sizing: border-box; border: none; outline: none;height: 32px; text-align: right;width: 88%;" placeholder="NOM" value="<?php echo $data_rincian_edit_[$k]->rppt2nom; ?>"></td>
                                            ...
                                            <td style="text-align: center; border-right: #f0f0f0 1px solid; padding: 0px; vertical-align: middle; width: 6%;"><input <?php echo $disabled_input; ?> autocomplete="off" name="tw3_<?php echo $alphabet_lanjutan[$keys_ma[$i]]; ?>_<?php echo ($j + 1); ?>[]" class="numberonly" type="number" style="background-color: white; box-sizing: border-box; border: none; outline: none;height: 32px; text-align: right;width: 88%;" placeholder="NOM" value="<?php echo $data_rincian_edit_[$k]->rppt3nom; ?>"></td>
                                            ...
                                            <td style="text-align: center; border-right: #f0f0f0 1px solid; padding: 0px; vertical-align: middle; width: 6%;"><input <?php echo $disabled_input; ?> autocomplete="off" name="tw4_<?php echo $alphabet_lanjutan[$keys_ma[$i]]; ?>_<?php echo ($j + 1); ?>[]" class="numberonly" type="number" style="background-color: white; box-sizing: border-box; border: none; outline: none;height: 32px; text-align: right;width: 88%;" placeholder="NOM" value="<?php echo $data_rincian_edit_[$k]->rppt4nom; ?>"></td>
