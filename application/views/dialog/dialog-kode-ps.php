<div class="modal fade" id="modal-daftar-kode-ps" style="z-index: 9999;">
    <div class="modal-dialog" style="width: 60%; margin: 9vh auto; height: 100%;">
        <div class="modal-content">
            <div class="modal-header" style="height: 8vh;">
                ...
                <h4 class="modal-title">Daftar Kode PS</h4>
            </div>
            <div class="modal-body" style="height: 60vh; overflow: auto; padding: 0px; margin: 0px;">
                ...
                <table id="table-data" class="table table-bordered table-hover">
                    <thead style="background-color: white;">
                        <tr>
                            <th style="white-space: nowrap;">Kode PS</th>
                            <th style="white-space: nowrap;">No Urut</th>
                            <th style="white-space: nowrap;">Deskripsi</th>
                        </tr>
                        <tr>
                            <th style="white-space: nowrap;padding-top: 0px; padding-bottom:0px;" colspan="3">
                                <input type="text" style="width: 100%;border: 0px;outline: none;height: 32px;" placeholder="Cari ...." id="search_text_kode_ps">
                            </th>
                        </tr>
                    </thead>
                    <tbody id="tbody_daftar_kode_ps" style="white-space: pre-wrap;">
                        <tr>
