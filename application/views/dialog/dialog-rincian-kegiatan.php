<div class="modal fade" id="modal-rincian-kegiatan" style="z-index: 9999;">
                    ...
                    <thead style="background-color: white;">
                        ...
                        <tr>
                            <th style="white-space: nowrap;padding-top: 0px; padding-bottom:0px;" colspan="3">
                                <input type="text" style="width: 100%;border: 0px;outline: none;height: 32px;" placeholder="Cari ...." id="search_text_dialog_rincian_kegiatan">
                            </th>
                        </tr>
                        
                    </thead>
                    <tbody id="tbody_hasil_data" style="white-space: pre-wrap;">
                        <tr>
                            <td colspan="3">Please Select Your Satker.</td>
                        </tr>
                    </tbody>
                </table>  
            </div>
