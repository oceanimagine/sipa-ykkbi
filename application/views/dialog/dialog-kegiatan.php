<div class="modal fade" id="modal-kegiatan-only" style="z-index: 9999;">
                    ...
                    <thead style="background-color: white;">
                        ...
                        <tr>
                            <th style="white-space: nowrap;padding-top: 0px; padding-bottom:0px;" colspan="3">
                                <input type="text" style="width: 100%;border: 0px;outline: none;height: 32px;" placeholder="Cari ...." id="search_text_dialog_kegiatan_only">
                            </th>
                        </tr>
                        
                    </thead>
                    <tbody id="tbody_hasil_data_kegiatan_only" style="white-space: pre-wrap;">
                        <tr>
