    ...
    <form class="form-horizontal" method="POST" enctype="multipart/form-data">
        <div class="box-body">
            ...
            <div class="form-group">
                ...
                <div class="col-lg-10">
                    <input required type="number" id="rekmakode" class="form-control numberonly-no-comma" name="rekmakode" placeholder="Rekma Kode" value="<?php echo isset($rekmakode) ? $rekmakode : "0"; ?>">
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-lg-10">
                    <input required type="text" id="rekmanama" class="form-control" name="rekmanama" placeholder="Rekma Nama" value="<?php echo isset($rekmanama) ? $rekmanama : ""; ?>">
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-lg-10">
                    <select name="rekmainduk" id="rekmainduk" class="form-control">
            ...
            <div class="form-group">
                ...
                <div class="col-lg-10">
                    <input required type="number" id="benchmarkang" class="form-control numberonly" name="benchmarkang" placeholder="Benchmark Angka" value="<?php echo isset($benchmarkang) ? $benchmarkang : "0.00"; ?>">
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-lg-10">
                    <input required type="number" id="benchmarkprog" class="form-control numberonly" name="benchmarkprog" placeholder="Benchmark Program" value="<?php echo isset($benchmarkprog) ? $benchmarkprog : "0.00"; ?>">
                </div>
            </div>
