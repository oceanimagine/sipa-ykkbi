        ...
        <div class="box-body" style="min-width: 1200px; position: relative;">
                ...
                <div class="col-xs-9 autocomplete">
                    ...
                    <div style="display: table; width: 100%; margin-top: 15px; display: none;" id="filter_sbp_container">
                        <div style="width: 2.5%; float: left;">
                            <input type="checkbox" name="sbpps_kode_filter" id="sbpps_kode_filter" style="width: 20px; margin: 0px !important; padding: 0px; display: block; overflow: hidden; height: 18px;">
                        </div>
            ...
            <div class="form-group">
                ...
                <div class="col-xs-5" id="tempat_satker_pkt_kode" style="padding-right: 6px;">
                    <select name="satker_pkt_kode" id="satker_pkt_kode" class="form-control">
                ...
                <div class="col-xs-5" id="tempat_nokegiatan_pkt_kode" style="padding-left: 6px;">
                    <select name="nokegiatan_pkt_kode" id="nokegiatan_pkt_kode" class="form-control">
                ...
                <div class="col-xs-5" id="tempat_norinciankegiatan_pkt_kode" style="display: none;">
                    <select name="norinciankegiatan_pkt_kode" id="norinciankegiatan_pkt_kode" class="form-control">
            ...
            <div class="form-group">
                ...
                <div class="col-xs-10">
                    <input type="text" id="pktnama" class="form-control" name="pktnama" placeholder="PKT Nama" value="<?php echo isset($pktnama) ? $pktnama : ""; ?>" />
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-xs-10">
                    <input type="text" id="pktoutput" class="form-control" name="pktoutput" placeholder="PKT Output" value="<?php echo isset($pktoutput) ? $pktoutput : ""; ?>" />
                </div>
            </div>
