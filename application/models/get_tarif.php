...
class get_tarif extends CI_Model {
    ...
    function get_data(){
        ...
        $sql_total = "select kode, satkerid, tarifid, tarifnama, tarifnom, tarifdesc from tbl_user_admin" . $clouse . "";

        $query_total = $this->db->query($sql_total);
        $total = $query_total->num_rows();

        $sql = "select satkerid as id, kode, satkerid, tarifid, tarifnama, tarifnom, tarifdesc from tbl_user_admin".$clouse." order by id asc offset $iDisplayStart limit $iDisplayLength";
