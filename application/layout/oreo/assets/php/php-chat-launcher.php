    ...
    <div class="card">
        <div class="header">
            <ul class="list-unstyled team-info margin-0">
                ...
                <li>
                    <img src="assets/images/avatar4.jpg" alt="Avatar">
                </li>
                <li>
                    <img src="assets/images/avatar6.jpg" alt="Avatar">
                </li>
                <li>
        ...
        <div class="body">
            <div class="chat-widget">
                <ul class="chat-scroll-list clearfix">
                    ...
                    <li class="left float-left"> <img src="assets/images/avatar2.jpg" class="rounded-circle" alt="">
                    ...
                    <li class="left float-left"> <img src="assets/images/avatar1.jpg" class="rounded-circle" alt="">
