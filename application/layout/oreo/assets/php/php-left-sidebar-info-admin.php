                ...
                <div class="user-info m-b-20 p-b-15">
                    ...
                    <div class="row">
                        ...
                        <div class="col-4 p-r-0">
                            <h5 class="number count-to m-b-5" data-from="0" data-to="18" data-speed="2500" data-fresh-interval="1200">18</h5>
                            <small>Exp</small>
                        </div>
                        <div class="col-4">
                            <h5 class="number count-to m-b-5" data-from="0" data-to="125" data-speed="2500" data-fresh-interval="1200">125</h5>
                            <small>Awards</small>
                        </div>
                        <div class="col-4 p-l-0">
                            <h5 class="number count-to m-b-5" data-from="0" data-to="148" data-speed="2500" data-fresh-interval="1200">148</h5>
                            <small>Clients</small>
                        </div>                                
                    </div>
                </div>
