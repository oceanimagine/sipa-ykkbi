...
class daftar_strategic_business_plan extends CI_Controller {
    ...
    public function script_table(){
        return $this->layout->loadjs("daftar_strategic_business_plan/get_daftar_strategic_business_plan");
    }
    ...
    public function hapus($id){
        ...
        redirect('daftar_strategic_business_plan');
    }
    ...
    public function add(){
        if($this->input->post('kode')){
            ...
            redirect('daftar_strategic_business_plan/add');
        }
