                ...
                for($j = 0; $j < sizeof($nama); $j++){
                    ...
                    $this->get_add_anggaran->process(array(
                        ...
                        'column_value' => array(
                            ...
                            '"rincian"' => $nama[$j],
                            '"tarifid"' => 0,
                            '"taridnom"' => change_empty_to_zero($tarif[$j]),
                            '"rinkuantitas"' => change_empty_to_zero($Q[$j]),
                            '"rinfrekwensi"' => change_empty_to_zero($F[$j]),
                            '"rintarif"' => change_empty_to_zero($tarif[$j]),
                            '"rintotal"' => change_empty_to_zero($subtotal[$j]),
                            '"rppt1perc"' => change_empty_to_zero($persen_tw1[$j]),
                            '"rppt2perc"' => change_empty_to_zero($persen_tw2[$j]),
                            '"rppt3perc"' => change_empty_to_zero($persen_tw3[$j]),
                            '"rppt4perc"' => change_empty_to_zero($persen_tw4[$j]),
                            '"rppt1nom"' => change_empty_to_zero($tw1[$j]),
                            '"rppt2nom"' => change_empty_to_zero($tw2[$j]),
                            '"rppt3nom"' => change_empty_to_zero($tw3[$j]),
                            '"rppt4nom"' => change_empty_to_zero($tw4[$j])
                        )
                    ));
                    $affected_rincian = 0;
                    if($this->affected){
                    ...
                    for($k = 0; $k < sizeof($nama); $k++){
                        ...
                        $this->get_add_anggaran->process(array(
                            ...
                            'column_value' => array(
                                ...
                                '"rincian"' => $nama[$k],
                                '"tarifid"' => 0,
                                '"taridnom"' => change_empty_to_zero($tarif[$k]),
                                '"rinkuantitas"' => change_empty_to_zero($Q[$k]),
                                '"rinfrekwensi"' => change_empty_to_zero($F[$k]),
                                '"rintarif"' => change_empty_to_zero($tarif[$k]),
                                '"rintotal"' => change_empty_to_zero($subtotal[$k]),
                                '"rppt1perc"' => change_empty_to_zero($persen_tw1[$k]),
                                '"rppt2perc"' => change_empty_to_zero($persen_tw2[$k]),
                                '"rppt3perc"' => change_empty_to_zero($persen_tw3[$k]),
                                '"rppt4perc"' => change_empty_to_zero($persen_tw4[$k]),
                                '"rppt1nom"' => change_empty_to_zero($tw1[$k]),
                                '"rppt2nom"' => change_empty_to_zero($tw2[$k]),
                                '"rppt3nom"' => change_empty_to_zero($tw3[$k]),
                                '"rppt4nom"' => change_empty_to_zero($tw4[$k])
                            )
                        ));
                        $affected_rincian = 0;
                        if($this->affected){
